...
inline Vec7 local_deformations(const Vec3 &x1, const Vec3 &x2, const Vec3 &X1, const Vec3 &X2, const Mat3 &U1,
                               const Mat3 &U2);
...
inline Mat7 b_matrix_a(const Vec3 &x1, const Vec3 &x2, const Vec3 &X1, const Vec3 &X2, const Mat3 &U1, const Mat3 &U2);

inline Mat7 local_stiffness_matrix(const Vec3 &X1, const Vec3 &X2, const Scalar E, const Scalar A, const Scalar G,
                                   const Scalar It, const Scalar Iy, const Scalar Iz);

inline Vec7 local_internal_forces(const Vec3 &x1, const Vec3 &x2, const Vec3 &X1, const Vec3 &X2, const Mat3 &U1,
                                  const Mat3 &U2, const Scalar E, const Scalar A, const Scalar G, const Scalar It,
                                  const Scalar Iy, const Scalar Iz);

inline Vec7 local_internal_forces_a(const Vec3 &x1, const Vec3 &x2, const Vec3 &X1, const Vec3 &X2, const Mat3 &U1,
                                    const Mat3 &U2, const Scalar E, const Scalar A, const Scalar G, const Scalar It,
                                    const Scalar Iy, const Scalar Iz);
